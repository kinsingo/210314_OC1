...
{
	//----History----
	return  "GA Dll updated on 2021-01-13(Blue Condition Change and Weight Condition Changed)";
}

extern "C" __declspec (dllexport) void Init_Algorithm_Applied_Vreg1_Compensation_Upper_Lv_Limit(int loop_count, bool Vreg1_Infinite_Loop, int Vreg1_Infinite_Count,
...
{
	double temp_Limit_X = Limit_X;
	double temp_Limit_Y = Limit_Y;

	if (Vreg1_Infinite_Count >= 3)
	{
		temp_Limit_X += Extension_X;
		temp_Limit_Y += Extension_Y;
	}

	if (abs(Measure_X - Target_X) < temp_Limit_X && abs(Measure_Y - Target_Y) < temp_Limit_Y && abs(Measure_Lv - Target_Lv) < Limit_Lv && Measure_Lv <= Target_Lv)
	{
		Vreg1++;

		if (Vreg1 < 0) Vreg1 = 0;
		if (Vreg1 > Vreg1_Register_Limit)Vreg1 = Vreg1_Register_Limit;
		if (Vreg1 == 0 || Vreg1 == Vreg1_Register_Limit)Gamma_Or_Vreg1_Out_Of_Register_Limit = true;		
	}
	else
	{
		Init_Algorithm_Applied_Vreg1_Compensation(loop_count, Vreg1_Infinite_Loop, Vreg1_Infinite_Count,
			Gamma_R, Vreg1, Gamma_B, Measure_X, Measure_Y, Measure_Lv, Target_X, Target_Y, Target_Lv
			, Limit_X, Limit_Y, Limit_Lv, Extension_X, Extension_Y
			, Gamma_Register_Limit, Vreg1_Register_Limit, Gamma_Or_Vreg1_Out_Of_Register_Limit, Within_Spec_Limit);
	}
}

extern "C" __declspec (dllexport) void Init_Algorithm_Applied_Vreg1_Compensation_Lower_Lv_Limit(int loop_count, bool Vreg1_Infinite_Loop, int Vreg1_Infinite_Count,
	int& Gamma_R, int& Vreg1, int& Gamma_B, double Measure_X, double Measure_Y, double Measure_Lv, double Target_X, double Target_Y, double Target_Lv
	, double Limit_X, double Limit_Y, double Limit_Lv, double Extension_X, double Extension_Y
	, int Gamma_Register_Limit, int Vreg1_Register_Limit, bool& Gamma_Or_Vreg1_Out_Of_Register_Limit, bool& Within_Spec_Limit)
{
...
extern "C" __declspec (dllexport) void Init_Algorithm_Applied_Vreg1_Compensation(int loop_count, bool Vreg1_Infinite_Loop, int Vreg1_Infinite_Count,
	int& Gamma_R, int& Vreg1, int& Gamma_B, double Measure_X, double Measure_Y, double Measure_Lv, double Target_X, double Target_Y, double Target_Lv
	, double Limit_X, double Limit_Y, double Limit_Lv, double Extension_X, double Extension_Y
	, int Gamma_Register_Limit, int Vreg1_Register_Limit, bool& Gamma_Or_Vreg1_Out_Of_Register_Limit, bool& Within_Spec_Limit)
{
	...
	int XY_Weight = 1;
	int LV_Weight = 1;
	Vreg1_Compensate_State vreg1_compensate_State(Vreg1, Vreg1_Register_Limit, Gamma_Register_Limit, Vreg1_Infinite_Loop, XY_Weight, LV_Weight, Target, Measure, Limit, Gamma);
	vreg1_compensate_State.Vreg1_Compensation();

	//(Reference Variables) Get R/Vreg1/B , Within_Spec_Limit , Gamma_Out_Of_Register_Limit 
	Gamma_R = vreg1_compensate_State.Get_Calculated_Gamma_R();
	Vreg1 = vreg1_compensate_State.Get_Calculated_Vreg1();
	Gamma_B = vreg1_compensate_State.Get_Calculated_Gamma_B();
	Within_Spec_Limit = vreg1_compensate_State.Get_Within_Spec_Limit();//Ref value
	Gamma_Or_Vreg1_Out_Of_Register_Limit = vreg1_compensate_State.Get_Gamma_Out_Of_Register_Limit();//Ref value
...
void Vreg1_Compensation_Upper_Lv_Limit(int loop_count, bool Vreg1_Infinite_Loop, int Vreg1_Infinite_Count, int& Gamma_R, int& Vreg1, int& Gamma_B, double Measure_X, double Measure_Y, double Measure_Lv, double Target_X, double Target_Y, double Target_Lv
	, double Limit_X, double Limit_Y, double Limit_Lv, double Extension_X, double Extension_Y, int Gamma_Register_Limit, int Vreg1_Register_Limit, bool& Gamma_Or_Vreg1_Out_Of_Register_Limit, bool& Within_Spec_Limit)
{
	...
	{
		Vreg1_Compensation(loop_count, Vreg1_Infinite_Loop, Vreg1_Infinite_Count, Gamma_R, Vreg1, Gamma_B, Measure_X, Measure_Y, Measure_Lv, Target_X, Target_Y, Target_Lv
			, Limit_X, Limit_Y, Limit_Lv, Extension_X, Extension_Y, Gamma_Register_Limit, Vreg1_Register_Limit, Gamma_Or_Vreg1_Out_Of_Register_Limit, Within_Spec_Limit);
	}
}

extern "C" __declspec (dllexport)
void Vreg1_Compensation_Lower_Lv_Limit(int loop_count, bool Vreg1_Infinite_Loop, int Vreg1_Infinite_Count, int& Gamma_R, int& Vreg1, int& Gamma_B, double Measure_X, double Measure_Y, double Measure_Lv, double Target_X, double Target_Y, double Target_Lv
	, double Limit_X, double Limit_Y, double Limit_Lv, double Extension_X, double Extension_Y, int Gamma_Register_Limit, int Vreg1_Register_Limit, bool& Gamma_Or_Vreg1_Out_Of_Register_Limit, bool& Within_Spec_Limit)
{
	double temp_Limit_X = Limit_X;
	double temp_Limit_Y = Limit_Y;
...
,double Limit_X,double Limit_Y,double Limit_Lv,double Extension_X,double Extension_Y , int Gamma_Register_Limit , int Vreg1_Register_Limit ,bool &Gamma_Or_Vreg1_Out_Of_Register_Limit,bool &Within_Spec_Limit)
{
	...
	Vreg1_Compensate_State vreg1_compensate_State(Vreg1, Vreg1_Register_Limit, Gamma_Register_Limit, Vreg1_Infinite_Loop, obj_weight->Get_XY_Weight(), obj_weight->Get_Lv_Weight(), Target, Measure, Limit, Gamma);
	vreg1_compensate_State.Vreg1_Compensation();
...
extern "C" __declspec (dllexport) void Init_Algorithm_Applied_Sub_Compensation_Upper_Lv_Limit(int loop_count, bool Infinite_Loop, int& Infinite_Count, int& Gamma_R,
	...
	int Gamma_Register_Limit, bool& Gamma_Out_Of_Register_Limit, bool& Within_Spec_Limit)
{
	...
	if (Target_Lv < 0.05 && Gamma_R < 40) temp_Limit_X += 0.005;//Added On 200429
	if (Target_Lv < 0.02 && Gamma_R < 30) temp_Limit_X += 0.005;//Added On 200429
	...
	if (abs(Measure_X - Target_X) < temp_Limit_X && abs(Measure_Y - Target_Y) < temp_Limit_Y && abs(Measure_Lv - Target_Lv) < Limit_Lv && Measure_Lv <= Target_Lv)
	{
		...
		if (Gamma_R < 0)Gamma_R = 0;
		if (Gamma_R > Gamma_Register_Limit)Gamma_R = Gamma_Register_Limit;
		if (Gamma_G < 0)Gamma_G = 0;
		if (Gamma_G > Gamma_Register_Limit)Gamma_G = Gamma_Register_Limit;
		if (Gamma_B < 0)Gamma_B = 0;
		if (Gamma_B > Gamma_Register_Limit)Gamma_B = Gamma_Register_Limit;

		if (Gamma_R == 0 || Gamma_G == 0 || Gamma_B == 0 || Gamma_R == Gamma_Register_Limit || Gamma_G == Gamma_Register_Limit || Gamma_B == Gamma_Register_Limit)
			Gamma_Out_Of_Register_Limit = true;
	}
	else
	{
		Init_Algorithm_Applied_Sub_Compensation(loop_count, Infinite_Loop, Infinite_Count, Gamma_R,
			Gamma_G, Gamma_B, Measure_X, Measure_Y, Measure_Lv, Target_X, Target_Y, Target_Lv
			, Limit_X, Limit_Y, Limit_Lv, Extension_X, Extension_Y,
			Gamma_Register_Limit, Gamma_Out_Of_Register_Limit, Within_Spec_Limit);
	}
}

extern "C" __declspec (dllexport) void Init_Algorithm_Applied_Sub_Compensation_Lower_Lv_Limit(int loop_count, bool Infinite_Loop, int& Infinite_Count, int& Gamma_R,
	int& Gamma_G, int& Gamma_B, double Measure_X, double Measure_Y, double Measure_Lv, double Target_X, double Target_Y, double Target_Lv
	, double Limit_X, double Limit_Y, double Limit_Lv, double Extension_X, double Extension_Y,
	int Gamma_Register_Limit, bool& Gamma_Out_Of_Register_Limit, bool& Within_Spec_Limit)
{
...
extern "C" __declspec (dllexport) void Init_Algorithm_Applied_Sub_Compensation(int loop_count, bool Infinite_Loop, int& Infinite_Count, int& Gamma_R,
	int& Gamma_G, int& Gamma_B, double Measure_X, double Measure_Y, double Measure_Lv, double Target_X, double Target_Y, double Target_Lv
	, double Limit_X, double Limit_Y, double Limit_Lv, double Extension_X, double Extension_Y,
	int Gamma_Register_Limit, bool& Gamma_Out_Of_Register_Limit, bool& Within_Spec_Limit)
{
	if (Target_Lv < 0.05 && Gamma_R < 40) Limit_X += 0.005;//Added On 200429
	if (Target_Lv < 0.02 && Gamma_R < 30) Limit_X += 0.005;//Added On 200429
	...
	int XY_Weight = 1;
	int LV_Weight = 1;
	RGB_Compensate_State compensation_state(Gamma_Register_Limit, Infinite_Loop, XY_Weight, LV_Weight, Target, Measure, Limit, Gamma);
	compensation_state.Init_Algorithm_Applied_Full_Compensation(loop_count, Infinite_Count);
...
extern "C" __declspec (dllexport) void Sub_Compensation_Upper_Lv_Limit(int loop_count, bool Infinite_Loop, int& Infinite_Count, int& Gamma_R, int& Gamma_G, int& Gamma_B, double Measure_X, double Measure_Y, double Measure_Lv, double Target_X, double Target_Y, double Target_Lv
	, double Limit_X, double Limit_Y, double Limit_Lv, double Extension_X, double Extension_Y, int Gamma_Register_Limit, bool& Gamma_Out_Of_Register_Limit, bool& Within_Spec_Limit)
{
	...
	{
		Sub_Compensation(loop_count, Infinite_Loop, Infinite_Count, Gamma_R, Gamma_G, Gamma_B, Measure_X, Measure_Y, Measure_Lv, Target_X, Target_Y, Target_Lv
			, Limit_X, Limit_Y, Limit_Lv, Extension_X, Extension_Y, Gamma_Register_Limit, Gamma_Out_Of_Register_Limit, Within_Spec_Limit);
	}
}

extern "C" __declspec (dllexport) void Sub_Compensation_Lower_Lv_Limit(int loop_count, bool Infinite_Loop, int& Infinite_Count, int& Gamma_R, int& Gamma_G, int& Gamma_B, double Measure_X, double Measure_Y, double Measure_Lv, double Target_X, double Target_Y, double Target_Lv
	, double Limit_X, double Limit_Y, double Limit_Lv, double Extension_X, double Extension_Y, int Gamma_Register_Limit, bool& Gamma_Out_Of_Register_Limit, bool& Within_Spec_Limit)
{
	double temp_Limit_X = Limit_X;
	double temp_Limit_Y = Limit_Y;
